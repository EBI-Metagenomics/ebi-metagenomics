...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <p class="intro"class="intro">
        If you believe this to be a broken link, then please consider <a title="EBI's support & feedback form" href="http://www.ebi.ac.uk/support/metagenomics" class="ext">contacting us</a> to report it.
