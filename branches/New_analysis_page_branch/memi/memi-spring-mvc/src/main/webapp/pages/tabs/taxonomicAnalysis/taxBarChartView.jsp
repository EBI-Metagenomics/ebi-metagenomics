...
// Taxonomy Bar - domain
        var options = {'title':'Domain composition', 'titleTextStyle':{fontSize:12}, 'fontName': '"Arial"', 'colors':['#5f8694'], 'width':210, 'height':140, 'chartArea':{left:70, top:30, width:"56%", height:"60%"},  'hAxis':{textStyle:{color:'#a8a8a8'}, gridlines:{count:4}}, 'vAxis':{textStyle:{fontSize:11}}, 'pieSliceBorderColor':'none', 'bar':{groupWidth:10}, 'legend':'none'};
