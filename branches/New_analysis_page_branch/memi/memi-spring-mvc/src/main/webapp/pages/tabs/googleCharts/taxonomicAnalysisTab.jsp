...
drawPhylumTable();
drawPhylumPieChart(phylumBarChartPieChartData);
drawPhylumBarChart(phylumBarChartPieChartData);
drawPhylumStackChart();
drawDomainCompositionPieChart(domainBarChartPieChartData);
drawDomainCompositionBarChart(domainBarChartPieChartData);
...
function drawPhylumPieChart(phylumBarChartPieChartData) {
...
function drawPhylumBarChart(phylumBarChartPieChartData) {
// Taxonomy Bar - phylum
...
function drawDomainCompositionBarChart(domainBarChartPieChartData) {
// Taxonomy Bar - domain
