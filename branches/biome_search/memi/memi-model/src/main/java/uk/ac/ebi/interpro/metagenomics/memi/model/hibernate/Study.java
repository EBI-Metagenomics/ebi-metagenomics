...
//    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (ncbiProjectId != null ? ncbiProjectId.hashCode() : 0);
        result = 31 * result + (submissionAccountId != null ? submissionAccountId.hashCode() : 0);
        result = 31 * result + (studyStatus != null ? studyStatus.hashCode() : 0);
        result = 31 * result + (publicReleaseDate != null ? publicReleaseDate.hashCode() : 0);
        result = 31 * result + (lastMetadataReceived != null ? lastMetadataReceived.hashCode() : 0);
        result = 31 * result + (centreName != null ? centreName.hashCode() : 0);
        result = 31 * result + (studyAbstract != null ? studyAbstract.hashCode() : 0);
        result = 31 * result + (experimentalFactor != null ? experimentalFactor.hashCode() : 0);
        result = 31 * result + (isPublic ? 1 : 0);
        result = 31 * result + (studyPageURL != null ? studyPageURL.hashCode() : 0);
        return result;
    }
