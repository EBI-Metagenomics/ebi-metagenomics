...
public class LoginPageController extends LoginController {
    ...
    public ModelAndView doGet(@RequestParam(required = true, defaultValue = "true") final boolean display, ModelMap model) {
    ...
    public ModelAndView doProcessLogin(
            ...
            final BindingResult bindingResult, ModelMap model, final SessionStatus sessionStatus,
