 ...
 *
 * @author  Antony Quinn
 * @version $Id: TextHighlighter.java,v 1.3 2012/09/12 14:32:24 matthew Exp $
 */
public final class TextHighlighter {
    ...
    private static final Pattern MID_SENTENCE_PATTERN = Pattern.compile("^[a-z].*");
    ...
    private String tidyFragments(String fragments) {
        ...
        if(MID_SENTENCE_PATTERN.matcher(fragments).matches()) {
