...
<div id="tax-col">
    <div class="chart_container">
        <div class="chart-block">
          ...
          <li class="chart_exp_png"><a onclick="saveAsImg(document.getElementById('tax_chart_col'),'<spring:message code="file.name.tax.col.chart.phylum"/>'), menu.hide;">Save PNG Image</a></li><li class="chart_exp_snap"> <a onclick="toImg(document.getElementById('tax_chart_col'), document.getElementById('img_div')), menu.hide;">Snapshot</a></li>
          </ul>
