          ...
          <h2> Data processing steps </h2>
                    <ol>
                        ...
                        <li>Nucleotide sequences processed
                         <ol><li>Clipped - low quality ends trimmed and adapter sequences removed using Biopython SeqIO package</li>
                          ...
                          <li>Duplicate sequences removed - clustered on 99% identity (UCLUST v 1.1.579), representative sequence chosen</li>
                          <li>Repeat masked - RepeatMasker (open-3.2.2), removed reads with 50% or more nucleotides masked</li>
                         </ol></li>
                        <li>CDS predicted (FragGeneScan v 1.15)</li>
                        <li> InterPro matches generated. pCDS were searched with InterProScan 5.0 (beta release) using InterPro release 31.0 (Databases included in search - Pfam). A Gene Ontology (GO) annotation profile was generated by mappings GO terms derived from InterPro matches to the following GO slim: goslim_goa</li>
                    </ol>
        </div>
       </div>
