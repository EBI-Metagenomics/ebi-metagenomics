...
<p class="intro">
    If you have data that you wish to have archived and analysed, you need an ENA submitter account to archive the data in ENA and view the results of the analysis on EBI metagenomics portal.
...
<p class="intro">With an ENA submitter account, you can submit your data directly using the <a class="ext" title="Click here to submit data to ENA" href="https://www.ebi.ac.uk/ena/submit/sra/#home"> Webin tool</a>, which will help you describe your metadata and upload your sequence read data.
