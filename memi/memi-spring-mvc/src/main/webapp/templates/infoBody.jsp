...
<p>They are then filtered to remove very short reads, duplicate reads and reads containing >10% unknown base calls. Over-lapping paired-end short reads are also merged.</p>
