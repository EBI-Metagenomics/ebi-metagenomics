...
/**
 * Represents a method provider/utility class. This class has one method to build up Velocity templates.
 *
...
public class VelocityTemplateWriter {
    ...
    /**
     * Creates a String representation of the specified Velocity template using the specified model.
     *
     * @param templateLocation Relative path to the Velocity template file.
     * @param model            Possibility to provide a model to the Velocity engine.
     */
