...
/**
 * Model builder class for {@link StatsViewModel}.
 * <p>
 ...
 * @since 1.4-SNAPSHOT
 */
public class StatsViewModelBuilder extends AbstractResultViewModelBuilder<StatsViewModel> {

    private final static Log log = LogFactory.getLog(StatsViewModelBuilder.class);

    public StatsViewModelBuilder(UserManager sessionMgr,
    ...
    public StatsViewModel getModel() {
        log.debug("Building instance of " + StatsViewModel.class + "...");
        ...
        return new StatsViewModel(getSessionSubmitter(sessionMgr), getEbiSearchForm(), pageTitle, breadcrumbs, propertyContainer, analysisJob.getSample(), analysisJob, analysisStatus);
    }
}