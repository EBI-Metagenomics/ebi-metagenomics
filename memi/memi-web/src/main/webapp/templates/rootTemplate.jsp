...
<div class="ebi_contents" id="contents"> <%-- style="margin:0; width:100%;"--%>
    ...
    <footer>
        <hr>
        <div id="elixir-banner" data-color="grey" data-name="EBI metagenomics"
             data-description=""
...
<script src="${pageContext.request.contextPath}/js/ebiSearch.js?v1.82" type="text/javascript"></script>
