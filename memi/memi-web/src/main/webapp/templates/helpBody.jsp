...
<p>All <a title="EMG-docs"
          href="http://emg-docs.readthedocs.io/en/latest/index.html"
    ...
    section. Furthermore, there are also the following training materials as part of the <a
            ...
            class="ext">EBI Train online</a>:
<ol>
    <li><a title="Quick Tour" href="https://www.ebi.ac.uk/training/online/course/ebi-metagenomics-portal-quick-tour"
           class="ext">Tutorial about the website</a></li>
    <li><a title="Submitting data to the ENA"
           href="https://www.ebi.ac.uk/training/online/course/ebi-metagenomics-portal-submitting-metagenomics-da"
           class="ext">Tutorial describing the data submission process</a></li>
    <li><a title="Analysis and exploration"
           href="https://www.ebi.ac.uk/training/online/course/ebi-metagenomics-analysing-and-exploring-metagenomics-data"
           class="ext">A webinar explaining about EBI metagenomics and the analysis you can perform</a></li>
</ol>
<p>
