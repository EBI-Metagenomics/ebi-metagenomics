...
<div class="grid_24 sample_ana" id="mainContainer">
    <div style="overflow: auto">
        ...
        <div id="spinner-container">
            ...
            <div id="spinner-percentage" class="spinner-percentage"></div>
        </div>
    </div>
    <div><p style="color:red;">Please note that the links from any search results will take you to our new website.</p></div>
    ...
    <form class="local-search-xs" action="javascript:pageManager.runSmallSearch();"
        ...
        <div class="grid_24">
            ...
            <div class="grid_6 omega"><input type="submit" id="searchsubmit" name="searchsubmit" value="Search"
                                             class="submit"></div>
