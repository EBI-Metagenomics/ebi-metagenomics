...
<p class="intro">We have detected that you already have an ENA account associated with your email address. You can use the <a class="ext" title="Click here to submit data to ENA via the ENA Webin Tool" href="https://www.ebi.ac.uk/ena/submit/sra/#home">ENA Webin tool</a> to upload your data.
