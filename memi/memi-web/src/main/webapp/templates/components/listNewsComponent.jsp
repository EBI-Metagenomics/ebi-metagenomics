<div id="list-news" class="grid_9 omega">
    ...
    <h2>
        <a href="http://twitter.com/MGnifyDB" alt="Follow us on Twitter"></a>News & events
    ...
    <%--<div class="tweet"></div>--%>
    <a class="twitter-timeline"  height="400" data-dnt="true" href="https://twitter.com/MGnifyDB" data-widget-id="345516657369837568">Tweets by @MGnifyDB</a>
    <script>
    !function(d,s,id){var
