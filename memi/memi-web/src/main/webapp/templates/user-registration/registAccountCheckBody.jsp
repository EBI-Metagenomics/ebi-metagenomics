...
<h2>Already registered?</h2>
    ...
    <c:url var="accountCheck" value="${baseURL}/registration"/>
    <form:form method="POST" commandName="registrationForm" action="${accountCheck}" id="sub_form">
            ...
            <c:if test="${isNewUser}">
                ...
                <p>A Webin account is an ENA submitter account provided by the European Nucleotide Archive. You
