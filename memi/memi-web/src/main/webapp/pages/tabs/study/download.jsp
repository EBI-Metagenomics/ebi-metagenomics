...
<div id="fragment-download">
    ...
    <div class="box-export">
        ...
        <c:forEach var="downloadSection" items="${model.downloadSectionMap}">
            ...
            <c:if test="${fn:length(downloadSection.value.statsDownloadLinks)>0 && continueExecuting}">
                <p>Additionally, estimates are provided for the number of individuals that would need to be sequenced in
                    ...
                    Poisson-log-normal taxa abundance distribution). These provide guidance for the sequencing effort
                    likely
                    to
