...
<div id="fragment-taxonomy">
    ...
    <div class="main_tab_full_content">
        <p>These are the results from the taxonomic analysis steps of our pipeline, based on the analysis of the large subunit of the ribosome RNA 16S. You can switch between different
