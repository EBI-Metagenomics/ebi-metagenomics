    ...
    <div class="chart_container">
        ...
        <div class="chart-block">
            ...
            <ul class="export_list">
                ...
                <li class="chart_exp png" id="bar_dom_png_h"><a
                        onclick="saveAsImg(document.getElementById('tax_chart_bar_dom'),'<spring:message code="file.name.tax.bar.chart.domain.high.png"/>',300/72);">PNG
                    (Higher quality)</a></li>
                <li class="chart_exp" id="bar_dom_svg"><a
                ...
                <li class="chart_exp png" id="bar_phy_png_h"><a
                        onclick="saveAsImg(document.getElementById('tax_chart_bar_phy'),'<spring:message code="file.name.tax.bar.chart.phylum.high.png"/>',300/72);">PNG
                    (Higher quality)</a></li>
                <li class="chart_exp" id="bar_phy_svg"><a
                        onclick="saveAsSVG(document.getElementById('tax_chart_bar_phy'),'<spring:message code="file.name.tax.bar.chart.phylum.svg"/>');">SVG</a>
                </li>
            </ul>
