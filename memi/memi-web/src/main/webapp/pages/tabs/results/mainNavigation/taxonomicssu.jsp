...
<div id="fragment-taxonomy">
    ...
    <div class="main_tab_full_content">
        <p>These are the results from the taxonomic analysis steps of our pipeline, based on the analysis of the small subunit (SSU) rRNA. You can switch between different
        ...
        <c:choose>
            ...
            <c:when test="${not empty model.sample.analysisCompleted && !model.analysisStatus.taxonomicAnalysisTabDisabled}">
                ...
                <div class="tabs-chart" id="tabs-taxchart">
                    <ul>
