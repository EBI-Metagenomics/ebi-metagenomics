...
//                    borderColor: '#686868',
            ...
            $('#tax_chart_bar_phy').highcharts({
                ...
                subtitle: {
                    <c:choose>
                    <c:when test="${model.run.releaseVersion == '1.0'}">
                    text: 'Total: ${model.taxonomyAnalysisResultSSU.sliceVisibilityThresholdDenominator} OTUs - Drag to zoom in/out',
                    </c:when>
                    <c:otherwise>
                    text: 'Total: ${model.taxonomyAnalysisResultSSU.sliceVisibilityThresholdDenominator} reads - Drag to zoom in/out',
                    </c:otherwise>
                    </c:choose>
                    style: {
                        fontSize:11,
...
//    <div id="legend"></div>
    ...
    <%--var readNum = "${fn:length(model.taxonomyAnalysisResultSSU.taxonomyDataSet)-1}";--%>
    <%--console.log(readNum);--%>
